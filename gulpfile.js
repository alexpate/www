...
gulp.task('buildSite', ['styles'], shell.task('jekyll build --incremental --config ' + argv.source + '/_config.yml,' + argv.source + '/_config.production.yml --source ' + argv.source + ' --destination ' + argv.destination));
