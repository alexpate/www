...
Linking an animation to a users scroll position is something that every front-end developer has had to do at some point.

It's a common pattern that normally requires writing a bit (or sometimes alot) of JavaScript. But did you know that you
might soon be able to do this natively in CSS?

CSS Scroll-driven Animations are a new proposal for creating animations that are tied to the scroll offset of an element.

## How can I use it?

Let's take a look at how you can use CSS Scroll-driven Animations in a few examples.

### Example 1

<ScrollAnimationDemoOne />

_(As of May 2024, this demo will only work in Chrome)_
