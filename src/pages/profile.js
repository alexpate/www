...
export default () => (
  <main>
    ...
    <Section>
      ...
      <P>
        Before that, I was a front-end developer at Pusher (2015 - 2017), where
        I helped work on the development of the new client dashboard, the new
        marketing website, as well as creating an internal pattern library.
      </P>
    </Section>
